...
public class ContourPipeline extends OpenCvPipeline {
    ...
    public static Scalar scalarLower = new Scalar(0.0, 150.0, 120.0);
    public static Scalar scalarUpper = new Scalar(255.0, 255.0, 255.0);

    // Yellow, freight or ducks!
    //public static Scalar scalarLowerPink = new Scalar(0.0, 100.0, 0.0);
    //public static Scalar scalarUpperPink = new Scalar(255.0, 170.0, 120.0);

    // Green                                             Y      Cr     Cb
    // public static Scalar scalarLowerPink = new Scalar(  0.0, 0.0, 0.0);
    // public static Scalar scalarUpperPink = new Scalar(255.0, 120.0, 120.0);
    ...
    public Mat processFrame(Mat input) {
        ...
        try {
            ...
            Core.inRange(mat, scalarLower, scalarUpper, processed);
            // Remove Noise
