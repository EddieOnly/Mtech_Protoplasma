...
public class OpenCV_Contour_3954_Test extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        myPipeline.configureScalarLower(scalarLowerYellow.val[0], scalarLowerYellow.val[1], scalarLowerYellow.val[2]);
        myPipeline.configureScalarUpper(scalarUpperYellow.val[0], scalarUpperYellow.val[1], scalarUpperYellow.val[2]);
        if (myPipeline.getRectArea() > 2000) {
            {
                numberOfColor = 2;
            }
